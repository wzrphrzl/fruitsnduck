...
loadSprite("bean", asset("./sprites/bean.png"));
loadSprite("mark", asset("./sprites/mark.png"));
loadSound("bean_voice", asset("./sounds/bean_voice.wav"));
loadSound("mark_voice", asset("./sounds/mark_voice.wav"));
loadBitmapFont("happy", asset("./fonts/happy_28x36.png"), 28, 36);
